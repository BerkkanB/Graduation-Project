      ...
      <ul className="nav nav-pills flex-column mb-auto">
        ...
        <li className="nav-item my-2">
          <Link to="/dashboard" className={getItemStyle(selectedPage,"/dashboard")}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-clipboard-data-fill mx-1" viewBox="0 0 16 16">
        ...
        <Link to="/graduation" className={getItemStyle(selectedPage,"/graduation")}>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-mortarboard-fill mx-1" viewBox="0 0 16 16">
        ...
        <Link to="/teachers" className={getItemStyle(selectedPage,"/teachers")}  >
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-vcard-fill mx-1" viewBox="0 0 16 16">
